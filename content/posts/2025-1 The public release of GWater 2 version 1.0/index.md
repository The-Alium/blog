...
GWater 2 completely surpasses the previous addon in all parameters. Now liquids don't look like a multitude of mixing squares, but like more realistic individual drops that can seamlessly merge. Performance has improved, the user interface has become more pleasant and has added sounds, and there are many settings, the ability to save presets, etc.
