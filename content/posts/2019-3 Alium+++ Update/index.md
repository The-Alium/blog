...
It is likely that we will initiate the addition of Counter-Strike: Source content to the server because Erick, being very smart, forgot to install it on the server. The addition of faceposeme will not be long in coming. Additionally, this week, we plan to update the main map; there won't be any new features, but bug fixes will be implemented.
