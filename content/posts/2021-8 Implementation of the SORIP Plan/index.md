...
The outcome of this plan may lead to various actions from Rubat. SORIP proposes that, firstly, to avoid a mass ban of publications, an additional category should be added for guides that make it onto the list. If not as a first step, then secondly, the rules that cannot be fully enforced should be removed. If not as a second step, then thirdly, the publications on the list should be deleted.
